...
final List<TestQuestion> islamicStudiesQuestions = [
  ...
  TestQuestion(
    ...
    subject: 'Islamic Studies',
    explanation:
        'Prophet Muhammad (SAW) was born in 570 CE, known as the Year of the Elephant.',
  ),
  TestQuestion(
    id: 'is_5',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Isra wal Miraj refers to the night journey from Makkah to Jerusalem and ascension to heaven.',
  ),
  TestQuestion(
    id: 'is_6',
  ...
  TestQuestion(
    ...
    subject: 'Islamic Studies',
    explanation:
        'Hijra refers to the migration of Muslims from Makkah to Madinah in 622 CE.',
  ),
  TestQuestion(
    id: 'is_9',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Ramadan is the ninth month of the Islamic calendar and the month of fasting.',
  ),
  TestQuestion(
    id: 'is_10',
  ...
  TestQuestion(
    ...
    subject: 'Islamic Studies',
    explanation:
        'Surah Al-Baqarah (The Cow) is the longest chapter in the Quran.',
  ),
  TestQuestion(
    id: 'is_12',
  ...
  TestQuestion(
    ...
    subject: 'Islamic Studies',
    explanation:
        'Angel Jibril (Gabriel) is the angel of revelation who brought the Quran to Prophet Muhammad (SAW).',
  ),
  TestQuestion(
    id: 'is_14',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Qiblah is the direction towards the Kaaba in Makkah that Muslims face during prayer.',
  ),
  TestQuestion(
    id: 'is_15',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Khadijah bint Khuwaylid was the first wife of Prophet Muhammad (SAW).',
  ),
  TestQuestion(
    id: 'is_16',
    ...
    subject: 'Islamic Studies',
    explanation:
        'The Battle of Badr, the first major victory for Muslims, took place in 2 AH (624 CE).',
  ),
  TestQuestion(
    id: 'is_17',
    ...
    options: [
      'Quranic verses',
      'Prophet\'s teachings and practices',
      'Islamic law',
      'Prayer times',
    ],
    correctAnswer: 1,
    subject: 'Islamic Studies',
    explanation:
        'Sunnah refers to the teachings, practices, and sayings of Prophet Muhammad (SAW).',
  ),
  TestQuestion(
    id: 'is_18',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Hajj is the major pilgrimage to Makkah, one of the five pillars of Islam.',
  ),
  TestQuestion(
    id: 'is_19',
  ...
  TestQuestion(
    ...
    subject: 'Islamic Studies',
    explanation:
        'Surah Al-Ikhlas (The Sincerity) emphasizes the absolute unity and uniqueness of Allah.',
  ),
  TestQuestion(
    id: 'is_22',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Jihad primarily means "struggle" or "effort" in the path of righteousness.',
  ),
  TestQuestion(
    id: 'is_23',
    question:
        'The cave where Prophet Muhammad (SAW) received the first revelation was:',
    options: ['Cave Thawr', 'Cave Hira', 'Cave Uhud', 'Cave Quba'],
    correctAnswer: 1,
    subject: 'Islamic Studies',
    explanation:
        'Cave Hira on Mount Jabal an-Nour is where Prophet Muhammad (SAW) received the first revelation.',
  ),
  TestQuestion(
    id: 'is_24',
  ...
  TestQuestion(
    ...
    subject: 'Islamic Studies',
    explanation:
        'Sahih Bukhari is the most authentic collection of Hadith compiled by Imam Muhammad al-Bukhari.',
  ),
  TestQuestion(
    id: 'is_26',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Zabiha is the Islamic method of slaughtering animals according to Shariah.',
  ),
  TestQuestion(
    id: 'is_27',
  ...
  TestQuestion(
    ...
    subject: 'Islamic Studies',
    explanation:
        'Jahiliyyah refers to the "Age of Ignorance" before Islam came to Arabia.',
  ),
  TestQuestion(
    id: 'is_29',
    ...
    subject: 'Islamic Studies',
    explanation:
        'The Treaty of Hudaybiyyah was a pivotal peace agreement between Muslims and Makkans.',
  ),
  TestQuestion(
    id: 'is_30',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Laylat al-Qadr (Night of Power) is when the first verses of Quran were revealed.',
  ),
  TestQuestion(
    id: 'is_31',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Shariah is the comprehensive Islamic law derived from Quran and Sunnah.',
  ),
  TestQuestion(
    id: 'is_32',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Abu Talib, the uncle of Prophet Muhammad (SAW), protected him during the early years.',
  ),
  TestQuestion(
    id: 'is_33',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Ashara Mubashshara refers to the ten companions promised Paradise by Prophet Muhammad (SAW).',
  ),
  TestQuestion(
    id: 'is_34',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Shura refers to the Islamic principle of consultation in decision-making.',
  ),
  TestQuestion(
    id: 'is_35',
  ...
  TestQuestion(
    ...
    subject: 'Islamic Studies',
    explanation:
        'The peaceful conquest of Makkah (Fatah Makkah) took place in 8 AH.',
  ),
  TestQuestion(
    id: 'is_38',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Zakat al-Fitr is the obligatory charity paid at the end of Ramadan.',
  ),
  TestQuestion(
    id: 'is_39',
    ...
    subject: 'Islamic Studies',
    explanation:
        'Maryam (Mary) is the mother of Prophet Isa (Jesus) in Islamic belief.',
  ),
  TestQuestion(
    id: 'is_40',
    ...
    subject: 'Islamic Studies',
    explanation:
        '"As-salamu alaykum" means "Peace be upon you" and is the standard Islamic greeting.',
  ),
];
